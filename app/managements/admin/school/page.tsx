        ...
        <div className="rounded-lg bg-white">
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle className="text-center">Buat Sekolah</DialogTitle>
              </DialogHeader>
              <div className="">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="font-bold">NAMA SEKOLAH</TableHead>
              <TableHead className="font-bold">TOTAL SISWA</TableHead>
              <TableHead className="font-bold">TOTAL GURU</TableHead>
              <TableHead className="font-bold">SISWA TELAT BAYAR</TableHead>
              <TableHead className="font-bold">PEMASUKAN</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {data.map((invoice) => (
